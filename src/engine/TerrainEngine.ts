  ...
  getDiagnostics(): Record<string, unknown> {
    return {
      ...
      settings: {
        ...
        compare: this.compare,
        textureMode: this.settings.textureMode,
        satellitePalette: this.settings.satmap,
        satellitePreview: this.settings.satmapPreview,
        material: this.settings.material,
        materialColor: this.settings.materialColor,
        roughness: this.settings.materialRoughness,
        grainMillimeters: this.settings.materialGrain,
        reliefMillimeters: this.settings.materialRelief,
        moisture: this.settings.materialMoisture,
        waterAbsorptionDistance: this.settings.waterAbsorption,
        waterFoam: this.settings.waterFoam,
      },
