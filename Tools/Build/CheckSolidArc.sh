...
for TEST in FaceLoft Tweak DirectModeling ChamferLoop TransformTweak CurvedTweak; do
...
echo "[SolidArc] Phase 34a–34f and Phase 35a loft, tweak, chamfer and curved-tweak gates passed"
