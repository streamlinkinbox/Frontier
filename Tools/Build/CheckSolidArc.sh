...
for TEST in FaceLoft Tweak DirectModeling ChamferLoop TransformTweak CurvedTweak ConcaveChamfer ConeChamfer ConnectedFaceLoft GeneralConnectedFaceLoft FaceEdit; do
...
echo "[SolidArc] Phase 34a–34f, Phase 35a–35d, Phase 36a–36b face-loft and face-edit gates passed"
