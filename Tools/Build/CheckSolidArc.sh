...
for TEST in FaceLoft Tweak DirectModeling ChamferLoop TransformTweak CurvedTweak ConcaveChamfer ConeChamfer ConnectedFaceLoft GeneralConnectedFaceLoft GeneralCurvedChamfer ArbitraryNonPlanarEdgeLoop Phase33VariableRadius FaceEdit; do
...
echo "[SolidArc] Phase 33/34a–34f, Phase 35a–35d, Phase 36a–36e face-loft, blend and face-edit gates passed"
