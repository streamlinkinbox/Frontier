...
echo "[SolidArc] Phase 33/34a–34f, Phase 35a–35d, Phase 36a–36s, Stages 1–3c/3e, unequal setbacks, bounded partial-edge/apex blends, bounded quadratic partial-edge, bounded partial cone-apex/oblique corner, bounded oblique quadratic partial/full-edge, bounded orthogonal/oblique/variable/oblique-variable rolling-ball-core G2, bounded eligible orthogonal/oblique/variable/oblique-variable G2 edge dispatch, bounded native-cone, half-turn, non-reflex and reflex partial-cone apex vertex dispatch, bounded native-cone and native partial-cone apex vertex chamfer, bounded unequal-radius coaxial bicone apex chamfer, bounded unequal-setback unequal-radius bicone apex chamfer, bounded unequal-radius coaxial bicone toroidal apex fillet, bounded equal-radius coaxial bicone toroidal apex fillet, bounded partial unequal-radius bicone apex chamfer, bounded partial unequal-radius bicone toroidal apex fillet, bounded partial equal-radius bicone toroidal apex fillet, bounded partial equal-radius bicone apex chamfer, bounded full-turn equal-radius bicone apex chamfer, bounded partial unequal-radius bicone chamfer with independent set-backs, bounded partial equal-radius bicone chamfer with independent set-backs, bounded full-turn equal-radius bicone chamfer with independent set-backs, bounded half-turn equal-radius bicone chamfer with independent set-backs, bounded half-turn unequal-radius bicone chamfer with independent set-backs, bounded half-turn equal-radius bicone apex toroidal fillet, bounded half-turn unequal-radius bicone apex toroidal fillet, bounded half-turn equal-radius bicone apex chamfer, bounded half-turn unequal-radius bicone apex chamfer, bounded reflex unequal-radius bicone apex chamfer, bounded non-box extruded convex-prism shell, bounded non-box pentagonal-prism face offset, bounded genus-one holed-prism face offset, bounded elliptical-prism face offset, bounded oblique triangular-prism face offset, bounded triangular-prism draft, and durable Phase 25/26/31/32/32z/38w/38x/38y/38z/39a/39b/39c/39d/39e/39f/39g/39h/39i/39j/39k/39l/39m/39n/39o/40/41/42/43/44/45 proof gates passed"
