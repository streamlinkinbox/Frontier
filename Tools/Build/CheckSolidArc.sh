...
for TEST in FaceLoft Tweak DirectModeling ChamferLoop TransformTweak CurvedTweak ConcaveChamfer; do
...
echo "[SolidArc] Phase 34a–34f and Phase 35a–35b loft, tweak, chamfer and curved/concave gates passed"
