...
FLAGS=(-std=c++20 -Wall -Wextra -Wpedantic -Wno-unused-function
       ...
       "-DSOLIDARC_PROOF_FOLDER=\"$WORK/proofs\"")
...
for TEST in FaceLoft Tweak DirectModeling; do
...
echo "[SolidArc] Phase 34a face loft and Phase 34b face/edge/vertex tweak gates passed"
