...
public:
    ...
    [[nodiscard]] const std::vector<StarRecord>& QuerySourceStars() const noexcept { return SourceStars; }
...
private:
    std::vector<StarRecord>     SourceStars; // Unbinned catalogue for editor charts.
