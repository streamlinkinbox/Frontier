        ...
        if (SeesSpace && StarsVisible && Celestial_.Stars != nullptr && !Celestial_.Stars->Empty())
        {
            ...
            if (Cell < Cells.size())
            {
                ...
                for (uint32_t I = 0u; I < Bucket.Count; ++I)
                {
                    ...
                    if(Star.Luminance<Celestial_.StarMinimumLuminance)continue;
