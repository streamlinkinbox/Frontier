...
public:
    ...
    struct CelestialSettings
    {
        ...
        //    the clock is simulation seconds, independent of the solar clock. A Static Sun does not freeze
        //    weather, and editing the day cycle does not teleport cloud noise.
        ...
        float StarMinimumLuminance=0,StarDepth=0,StarRate=1,StarSeconds=0;
