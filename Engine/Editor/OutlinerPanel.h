...
//                                                     OUTLINERPANEL.H
//============================================================================================================================================
// 🧩 Development editor outliner — the instance roster as an outline. Header, search, category chips, thirty-pixel rows,
//    footer. The panel borrows the roster each tick and edits it in place: renames, toggles and the folder
