...
assert any(l.startswith('PostConstants:') and 'size 208,' in l and 'binding 24,' in l for l in lines)
...
print(result.stdout);print('PASS: Stars post uniform layout / 208 bytes / binding 24')
