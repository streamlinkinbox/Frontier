...
lines=[l for l in reflect.splitlines() if l.startswith(('Post','Weather:'))]
assert any(l.startswith('Weather:') and 'offset 208,' in l and 'size 19,' in l and 'arrayStride 16' in l for l in lines)
assert any(l.startswith('PostConstants:') and 'size 512,' in l and 'binding 24,' in l for l in lines)
...
assert 'kPostRecordBytes = 512u' in host and 'PostPending.data()+492u' in host
