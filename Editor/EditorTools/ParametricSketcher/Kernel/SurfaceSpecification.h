...
public:
    ...
    [[nodiscard]] Tessellation Tessellate(double ChordTolerance = ScalarCriteria::ChordTolerance, int MinimumPerSpan = 2, int MaximumPerSpan = ScalarCriteria::ChordSubdivision) const noexcept;
