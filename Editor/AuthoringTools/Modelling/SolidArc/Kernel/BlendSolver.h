...
// A bounded native-cone apex chamfer. SetBack is measured along the cone generator from the apex;
// arbitrary vertex chamfers and mixed-support apex edits remain outside this descriptor.
