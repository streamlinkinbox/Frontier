...
npm run verify     # the app's own 47-scenario sweep
```
...
tube chōchin 筒提灯, round chōchin 丸提灯, andon 行灯, tall kiriko 切子, paper
globe 明かり, and stone tōrō 石灯籠 (6-part). Each group: eave-hung or standing,
count, size, glow, paper/frame colours, and **custom characters drawn vertically
on the paper**. Night mode in the viewer shows them off.
