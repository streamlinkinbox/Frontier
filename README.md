...
npm run verify     # the app's own 71-scenario sweep
```
...
**Lantern generator**: 3 independent groups, each with 12 procedural designs in
...
청사초롱, paper globe 明かり, stone tōrō 石灯籠 and tall hexagonal Kasuga tōrō
春日灯籠. Each group: count, size, glow, paper/frame colours, **custom characters
